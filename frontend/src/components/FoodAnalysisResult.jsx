// This component displays the results of the food analysis.
// It receives the food items as props and displays their nutritional information.
// It also provides a button to confirm and save the results.
